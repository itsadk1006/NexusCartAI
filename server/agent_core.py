...
MOCK_CATALOG = {
    ...
    "vanilla extract": {"sku": "SKU_VANILLA_01", "name": "Pure Vanilla Extract (50ml)", "price_inr": 220, "stock": 0, "is_margin_booster": False},
    "cake tin": {"sku": "SKU_TIN_01", "name": "8-inch Non-Stick Cake Tin", "price_inr": 250, "stock": 12, "is_margin_booster": True},
    "birthday candles": {"sku": "SKU_CANDLE_01", "name": "Metallic Birthday Candles (10pk)", "price_inr": 80, "stock": 30, "is_margin_booster": True}
}
